                ...
                <tbody className="divide-y divide-slate-100">
                  {filteredCustomers.map(c => (
                    <tr key={c.id} className="hover:bg-slate-50 group cursor-pointer" onClick={() => openProfile(c)}>
                      ...
                      <td className="p-4 text-right font-medium text-slate-900">${c.totalSpent.toLocaleString()}</td>
                 ...
                 <tbody className="divide-y divide-slate-100">
                   {customerHistory.map(sale => (
                     <tr key={sale.id} className="hover:bg-slate-50">
                       ...
                       <td className="p-4 text-right font-bold text-slate-900">${sale.totalAmount.toFixed(2)}</td>
                     </tr>
                   ))}
